...
export const schema = yup
   .object({
      ...
      mobile: yup
         ...
         .test("isValidPhone", "O número de celular deve ser válido", (value) =>
            isValidPhone(value),
         ),
      document: yup
         .string()
      ...
      zipCode: yup
         ...
         .transform((value) => value.replace(/[^\d]+/g, ""))
         .test("isValidCep", "Insira um CEP válido", (value) => isValidCEP(value)),
      ...
      creditCardSecurityCode: yup
         ...
         .transform((value) => value.replace(/[^\d]/g, ""))
         .min(3, "O CVV deve possuir entre 3 a 4 dígitos")
         .max(4, "O CVV deve possuir entre 3 a 4 dígitos"),
   })
   .required();

export type FieldInputValues = yup.InferType<typeof schema>;
